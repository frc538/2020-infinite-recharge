...
public class ResetColorCommand extends CommandBase {

  private final ColorWheelSubsystem mColorWheelSubsystem;
  /**
   * Creates a new ResetColorCommand.
   */
  public ResetColorCommand(ColorWheelSubsystem colorWheelSubsystem) {
  ...
  public void execute() {
    ...
    mColorWheelSubsystem.resetColor();
