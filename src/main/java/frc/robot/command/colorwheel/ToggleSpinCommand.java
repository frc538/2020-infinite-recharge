...
public class ToggleSpinCommand extends CommandBase {

  private final ColorWheelSubsystem mColorWheelSubsystem;
  /**
   * Creates a new ToggleSpinCommand.
   */
  public ToggleSpinCommand(ColorWheelSubsystem colorWheelSubsystem) {
  ...
  public void execute() {
    ...
    mColorWheelSubsystem.toggleSpin();
